...
//                        registerMousns(context,phoneNumber,"123456",bean.getData().getData());
    ...
    public void  registerMousns(Context context, String account, String password, String smsCaptcha){
